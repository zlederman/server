...
string topDirTemplate = 
	...
	"<h1>dir-name</h1>"
	"<table>"
	"<tr><th valign=\"top\"><img src=\"index.gif\" alt=\"[ICO]\"></th><th><a href=\"?C=N;O=D\">Name</a></th><th><a href=\"?C=M;O=A\">Last modified</a></th><th><a href=\"?C=S;O=A\">Size</a></th><th><a href=\"?C=D;O=A\">Description</a></th></tr>";
